  ...
  if (step === 3) {
    return (
      <SpotlightTip
        ...
        radius={16}
        lines={[
          'Тут щодня з\u2019являтимуться нові відео.',
          'Одне — навчальний матеріал із різних курсів нашої школи, що охоплює важливі теми. Почнемо з простих тем, а з кожним днем складність поступово зростатиме.',
          'Друге — актуальні теми, пов\u2019язані з AI, останніми оновленнями в Meta Ads та інших рекламних кабінетах чи інструментах.',
        ]}
        confirmLabel="Зрозумів"
        onConfirm={() => setStep(4)}
        hintNumber={3}
