  ...
  if (step === 3) {
    return (
      <SpotlightTip
        ...
        radius={16}
        lines={[
          'Тут щодня з\u2019являтиметься нове відео — актуальні теми, пов\u2019язані з AI, останніми оновленнями в Meta Ads та інших рекламних кабінетах чи інструментах.',
          'А поруч кнопка «Додати свій сценарій»: можна вставити чат клієнта з брифом або одразу перейти в навчальний режим і будувати воронку з вибору ніші.',
        ]}
        confirmLabel="Зрозумів"
        onConfirm={() => setStep(4)}
        onSkipAll={skipTour}
