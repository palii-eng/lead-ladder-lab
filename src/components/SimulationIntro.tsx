...
const HARD_CLIENTS: ClientTemplate[] = [
  ...
  { name: 'Богдан', gender: 'male', role: 'Власник ресторану', niche: 'Сімейний ресторан',
    ...
    task: 'Доброго дня. Маю сімейний ресторан, працюємо вже 6 років переважно на постійних гостях та сарафанному радіо. Дружина наполягає, що пора пробувати рекламу в інтернеті — каже, що молодша аудиторія нас просто не знає. Чесно, я в цьому не дуже розбираюсь і ставлюсь скептично, але готовий спробувати. Цікавить насамперед збільшення бронювань банкетів та днів народжень. Підкажіть, з чого почати і який бюджет потрібен?' },
  ...
  { name: 'Валера', gender: 'male', role: 'Власник СТО', niche: 'Шиномонтаж',
    ...
    task: 'Доброго ранку. Мені племінник сказав, що ви рекламою в інтернеті займаєтесь. Треба, щоб клієнти йшли на шиномонтаж, сезон же. Бюджет — дам 2 тисячі, а ви мені 100 клієнтів за тиждень. По руках? Тільки без передоплати, я людям, яких перший раз бачу, грошей не плачу.' },
  ...
  { name: 'Артем', gender: 'male', role: 'MLM-лідер', niche: 'Мережевий маркетинг',
    ...
    task: 'Привіт, друже! 🚀 Бачу ти в темі реклами, а я в темі бізнесу можливостей. Давай так: ти мені приводиш людей в команду, я тобі — % з обороту структури. Це не пирамида, це смарт-бізнес 21 століття. Готовий розказати деталі — скажи, цікаво?' },
