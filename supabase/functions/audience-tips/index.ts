...
5. ❤️ **Інтереси та поведінка** — 8–12 конкретних інтересів/поведінок Meta для цієї ніші, з приблизним розміром аудиторії. Просто список — БЕЗ групування в адсети
6. 📱 **Плейсменти** — які увімкнути / вимкнути для цієї цілі, з поясненням
7. ⚡ **3 швидкі поради** — найважливіше саме по аудиторіям

Формат: структурований список без вступу, одразу до справи. Жодних згадок про "Адсет №1" чи структуру адсетів.`;
