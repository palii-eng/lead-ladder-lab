...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Ти — експерт з Facebook/Meta реклами. Давай конкретні, практичні рекомендації українською мовою. Будь лаконічним — максимум 5-7 пунктів. Використовуй емодзі для структурування.`;
