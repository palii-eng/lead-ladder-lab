...
- Виняток: ніша "стоматологія"/"стоматологічна клініка" — CPM ЗАВЖДИ від $6 і вище (по всіх країнах), бо це висококонкурентна дорога ніша.
- CPL (ціна за лід) у $0.5–$4 залежно від інструмента та ніші — ОБОВ'ЯЗКОВО рахуй і повертай явним числом (не залишай порожнім/нульовим), навіть якщо його треба вивести з cpm/ctr/landingConversion.
- Середній чек у $ конвертуй з типового UAH-чеку ніші за курсом ~40 UAH/USD

Правила (ОБОВ'ЯЗКОВІ ЦІЛЬОВІ ROI) — НАВМИСНО ПЕСИМІСТИЧНІ, без прикрашання. Це навчальна симуляція, і завищені прогнози привчають студентів до нереалістичних очікувань від реального ринку. Закладай ГІРШІ цифри, ніж тобі здається реалістичним, — краще, щоб студент був приємно здивований результатом, ніж розчарований:
- "Реалістичний" сценарій ПОВИНЕН давати чистий ROI приблизно -10%..0% (тобто Чистий дохід = Прибуток - Бюджет — на межі беззбитковості або трохи в мінус). Це типовий важкий старт нового кабінету, а не впевнений плюс.
...
- Тримай значення в межах реальних бенчмарків ($CPM 1.5–6, або від 6 для стоматології; CTR 0.8–2.5%, landing conv 3–12%, sale conv 2–10%), маржинальність 30–70% залежно від ніші.
