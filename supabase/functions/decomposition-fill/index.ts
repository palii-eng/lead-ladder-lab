...
Правила (ОБОВ'ЯЗКОВІ ЦІЛЬОВІ ROI) — навмисно консервативні, без прикрашання. Це навчальна симуляція, і завищені прогнози привчають студентів до нереалістичних очікувань від реального ринку:
- "Реалістичний" сценарій ПОВИНЕН давати чистий ROI приблизно +5–15% (тобто Чистий дохід = Прибуток - Бюджет ≈ +10% від бюджету). Це щойно вийшов у плюс, типовий старт нового кабінету, а не впевнено прибутковий.
- "Гірший" сценарій повинен давати чистий ROI приблизно -30..-40% (помітно збитковий старт).
- "Кращий" сценарій — чистий ROI приблизно +35–50%. Навіть найкращий сценарій не повинен виглядати як легкі гроші.
